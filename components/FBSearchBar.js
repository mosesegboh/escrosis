...
class FBSearchBar extends React.Component {
    ...
    _onFocus = () => {
        ...
        //run animation
        timing(this._input_box_translate_x, _input_box_translate_x_config).start()
                ...
                <SafeAreaView style={styles.header_safe_area}>
                    <View style={styles.header}>
                        <View style={styles.header_inner}>
                            ...
                            <Animated.View
                                style={[styles._input_box, {transform: [{translateX: this._input_box_translate_x}]}]}
                            >
